...
enum class StrId : uint16_t {
  ...
  STR_LANGUAGE,
  STR_TIME_ZONE,
  STR_SLEEP_WHILE_POWERED,
  STR_TIME_ZONE_JST9,
  STR_TIME_ZONE_UTC0,
  STR_TIME_ZONE_CST8,
  STR_TIME_ZONE_IST5D30,
  STR_TIME_ZONE_PST8PDT,
  STR_TIME_ZONE_MST7MDT,
  STR_TIME_ZONE_CST6CDT,
  STR_TIME_ZONE_EST5EDT,
  STR_TIME_ZONE_CET,
  STR_TIME_ZONE_GMT0BST,
  STR_TIME_ZONE_AEST10AEDT,
  STR_TIME_ZONE_NZST12NZDT,
  ...
  STR_TODAY_READING_TIME,
  STR_STATS_STREAK,
  STR_STATS_ACTIVE_DAYS,
  STR_STATS_THIS_WEEK,
  STR_STATS_RECENT_BOOKS,
  STR_CTRL_H_TITLE,
  STR_CTRL_H_LEFT,
  STR_CTRL_H_RIGHT,
  STR_CTRL_H_UP_DN,
  ...
  STR_TIME_SYNC,
  STR_TIME_SYNCING,
  STR_TIME_SYNC_SUCCESS,
  STR_TIME_SYNC_FAILED,
  STR_SYNC_RESULT_FORMAT,
